...
const Navbar = (props) => {
  return (
    <div className="p-0.5 flex">
      <div className="bg-[#13131c]  text-amber-50  h-12 p-4  w-full flex flex-row justify-between items-center">
        ...
        <div className="flex gap-5  justify-center items-center">
          <div className="relative">
            ...
            <input
              ...
              className=" bg-[#282c38] h-10 pl-13 rounded-sm border-2 border-[#2d3532]"
            ></input>
          </div>

          <div className="flex gap-5 border-l-2 border-r-2 border-[#2d3532] h-8   p-2.5">
            <Bell />
            <Moon />
          </div>
