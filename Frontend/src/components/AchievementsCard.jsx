    ...
    <div className="bg-[#1c1f28] border border-[#2a2d36] rounded-2xl w-125 p-6 shadow-sm h-150 ">
      ...
      <div className="grid grid-cols-2 gap-3">
        {achievements.map((ach, idx) => (
          <div
            key={idx}
            className="bg-[#15171e] border border-[#2a2d36] rounded-xl p-4 flex flex-col items-center justify-center text-center"
          >
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 ${ach.bg} ${ach.color}`}
            >
              {ach.icon}
            </div>
