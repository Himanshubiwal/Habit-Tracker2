...
const Navbar = (props) => {
  return (
    <div className="p-0.5 flex">
      <div className="bg-[#1e1f24]  text-amber-50  h-20 p-4 rounded-xl w-full flex flex-row justify-between items-center">
        <div className="flex gap-5 items-center">
          ...
          <h1 className="text-3xl text-[#b7b8bd] pb-2">Dashboard</h1>
        </div>
